    ...
    <div class="container-lg">
      ...
      <div class="collapse navbar-collapse ms-5" id="navbarNav">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item"><router-link to="/tareas" class="nav-link">Tareas</router-link></li>
          <li class="nav-item"><router-link to="/estadisticas" class="nav-link">Estadísticas</router-link></li>
          <li class="nav-item"><router-link to="/about" class="nav-link">Quienes Somos</router-link></li>
        </ul>
      </div>
    </div>
  </nav>
